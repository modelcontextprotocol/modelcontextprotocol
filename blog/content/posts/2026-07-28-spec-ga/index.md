...
The new release is MCP's most important since remote MCP first launched over a year ago. In particular, the stateless core makes MCP much easier to run reliably at scale. It takes all the lessons learned over the last 18 months and makes MCP ready for the future.
{{< /quote >}}
