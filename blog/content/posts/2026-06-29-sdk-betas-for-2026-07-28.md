---
title: "SDK Betas for MCP 2026-07-28"
...
author:
  - Felix Weinberger (SDK Working Group Lead)
  - Max Isbey (SDK Maintainer)
...
The MCP protocol is about undergo its biggest revision since launch. The
...
[The Future of MCP Transports](/posts/2025-12-19-mcp-transport-future/). You can now scale your server using a simple round-robin load balancer, removing the need for to manage
sticky sessions and to store shared sessions.

Starting today you can start testing all the forthcoming updates to the protocol. All four
[Tier 1](https://modelcontextprotocol.io/community/sdk-tiers) SDKs, 
[Python](https://github.com/modelcontextprotocol/python-sdk),
[TypeScript](https://github.com/modelcontextprotocol/typescript-sdk),
[Go](https://github.com/modelcontextprotocol/go-sdk), and
[C#](https://github.com/modelcontextprotocol/csharp-sdk), now support the spec updates in beta.  Run the beta SDKs against your real workloads
and tell us what breaks ahead of the final specification rollout. The specification will be finalized on July 28, 2026.
...
- The stable releases remain the recommended versions for production.
  Installing any of the four SDKs without explicitly requesting a
  pre-release still resolves to a stable version. After v2 ships, the
  TypeScript SDK will keep shipping v1.x bug fixes and security updates
  for at least six months, and the Python v1.x line continues to receive
...
TypeScript and Go SDKs, upgrading does not by itself change what your
server speaks over HTTP. Serving `2026-07-28` is an explicit choice you
make when you wire up the transport.
...
## Go and C#: version bumps, not rewrites

The Go and C# betas take a gentler path: no package split and no rework of
...
[SDK documentation](https://go.sdk.modelcontextprotocol.io) covers the
API.

The C# beta is `2.0.0-preview.1` of the `ModelContextProtocol` packages:

```bash
dotnet add package ModelContextProtocol --prerelease
```

Stable v1.x APIs keep working in 2.0. The breaking changes are confined to
...
[SDK documentation](https://csharp.sdk.modelcontextprotocol.io) has the
API reference.

## What the betas implement

All four betas implement the protocol changes from the release candidate,
...
3. File what you find. SDK problems go to the issue tracker for the SDK
   ...
   [Go](https://github.com/modelcontextprotocol/go-sdk/issues), or
   [C#](https://github.com/modelcontextprotocol/csharp-sdk/issues).
   Problems with the protocol itself go to the
...
range. The Go and C# installs above already record the exact version in
`go.mod` and your project file. The stable v2 releases are targeted alongside the final
