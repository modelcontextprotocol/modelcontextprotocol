...
function generateBadgeSnippet(): string {
  // Use lighter backgrounds in dark mode for better readability
  return `export const Badge = ({ children, color = "gray" }) => {
  const colors = {
    green: "bg-green-100 text-green-800 dark:bg-green-500/20 dark:text-green-400",
    ...
    orange: "bg-orange-100 text-orange-800 dark:bg-orange-500/20 dark:text-orange-400",
