...
You'll need [Node.js](https://nodejs.org/en/download) 20 or higher. Familiarity
...
```bash
npm install @modelcontextprotocol/ext-apps @modelcontextprotocol/server @modelcontextprotocol/node
