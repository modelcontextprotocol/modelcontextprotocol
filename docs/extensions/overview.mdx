...
[Skills over MCP](/extensions/skills/overview) distributes workflow instructions
and supporting files through MCP resources. SEP-2640 has been accepted;
finalization is in progress. See the
[implementation support table](/extensions/skills/overview#implementation-support)
for product scope and implementation status, and the
[Extension Support Matrix](/extensions/client-matrix) to compare extensions.
