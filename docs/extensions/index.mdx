...
Extensions are optional additions to the Model Context Protocol that provide functionality or guidance for specific use cases without requiring changes to the core specification.
...
- Follow the same governance and contribution process as the core protocol
