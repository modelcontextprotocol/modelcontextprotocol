...
If you do not have an MCP server written in TypeScript, you can create a copy of the `hello-mcp-registry` server to follow along with this tutorial:

```bash
git clone --branch quickstart git@github.com:jonathanhefner/hello-mcp-registry.git
cd hello-mcp-registry
...
```diff package.json
 {
-  "name": "hello-mcp-registry",
-  "version": "0.1.0",
+  "name": "@my-username/hello-mcp-registry",
+  "version": "0.1.1",
...
+  "repository": {
+    "type": "git",
+    "url": "https://github.com/my-username/hello-mcp-registry.git"
+  },
   "type": "module",
...
```diff package.json
 {
   "name": "@my-username/hello-mcp-registry",
   "version": "0.1.1",
+  "mcpName": "io.github.my-username/hello-mcp-registry",
   "description": "A simple MCP server.",
   "keywords": [
     "mcp"
```
...
cd my-username/hello-mcp-registry
...
You can verify your package is published by visiting its npm URL, such as https://www.npmjs.com/package/@my-username/hello-mcp-registry.
...
```json server.json
{
  ...
  "name": "io.github.my-username/hello-mcp-registry",
  "description": "A simple MCP server.",
  "repository": {
    "url": "https://github.com/my-username/hello-mcp-registry",
    "source": "github"
  },
  "version": "1.0.0",
  "packages": [
    {
      "registryType": "npm",
      "identifier": "@my-username/hello-mcp-registry",
      "version": "1.0.0",
      "transport": {
        "type": "stdio"
      },
...
✓ Server io.github.my-username/hello-mcp-registry version 0.1.1
```

You can verify that your server is published by searching for it using the MCP Registry API:

```bash
curl "https://registry.modelcontextprotocol.io/v0.1/servers?search=io.github.my-username/hello-mcp-registry"
```

You should see your server's metadata in the search results JSON:

```text Output
{"servers":[{ ... "name":"io.github.my-username/hello-mcp-registry" ... }]}
```
