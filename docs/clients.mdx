...
export const CAPABILITIES = ["Resources", "Prompts", "Tools", "Discovery", "Sampling", "Roots", "Elicitation", "Instructions", "Tasks", "Client ID Metadata Documents (CIMD)", "Dynamic Client Registration (DCR)"];
...
<McpClient
  ...
  supports="Resources, Prompts, Tools, Dynamic Client Registration (DCR)"
  instructions={[
...
<McpClient
  ...
  supports="Resources, Prompts, Tools, Elicitation, Instructions, Tasks, Client ID Metadata Documents (CIMD), Dynamic Client Registration (DCR)"
...
<McpClient
  ...
  supports="Resources, Prompts, Tools, Discovery, Sampling, Roots, Elicitation, Instructions, Client ID Metadata Documents (CIMD), Dynamic Client Registration (DCR)"
