...
<McpClient
  name="AgentOne"
  homepage="https://www.agent-one.dev/"
  supports="Tools, CIMD, DCR"
>

AgentOne is a cross-platform desktop AI agent that supports multiple LLM providers and integrates with MCP servers for tool usage. It supports both local (STDIO) and remote (HTTP) MCP servers with full OAuth authentication and Dynamic Client Registration.

**Key features:**

- Tools support from configured MCP servers via both STDIO and HTTP transports
- OAuth authentication with Dynamic Client Registration for remote MCP servers
- Cross-platform desktop app (Windows, macOS, Linux) built with Tauri
- Support for multiple LLM providers

**Learn more:**

- [AgentOne Documentation](https://docs.agent-one.dev/docs)
- [Get help from the Discord community](https://www.agent-one.dev/discord)
...
<McpClient
  ...
  supports="Tools, Apps, DCR, CIMD, Instructions"
...
<McpClient
  ...
  supports="Resources, Tools, Elicitation, Instructions"
