...
[VT Code](https://github.com/vinhnx/vtcode) is a lightweight code assistant that integrates with Model Context Protocol (MCP) servers, focusing on predictable tool permissions and robust transport controls.
...
- Test suite for configuration parsing and allowlist enforcement, plus an opt-in Context7 smoke test
