...
[Amp](https://ampcode.com) is an agentic coding tool built by Sourcegraph. It runs in VSCode (and compatible forks
like Cursor, Windsurf, and VSCodium), JetBrains IDEs, and as a command-line tool. It’s also multiplayer —
you
can share threads and
