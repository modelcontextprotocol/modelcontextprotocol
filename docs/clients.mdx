...
<McpClient
  ...
  supports="Apps, Enterprise-Managed Authorization"
>

Archestra is an agentic AI workspace and MCP gateway for building, orchestrating, and securing AI workflows across internal and external tools.
...
- Brokers downstream credentials for upstream MCP servers through its gateway architecture.
