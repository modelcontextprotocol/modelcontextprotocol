...
| Client                                           | [Resources] | [Prompts] | [Tools] | [Discovery] | [Sampling] | [Roots] | [Elicitation] | [STDIO] | [SSE] | [Streamable HTTP] |
| ------------------------------------------------ | ----------- | --------- | ------- | ---------------------- | ---------- | ----- | ------------ | ----------- | ----------- | ----------- |
| [5ire][5ire]                                     | ❌          | ❌        | ✅      | ❓                     | ❌         | ❌    | ❓            | ❓          | ❓          | ❓          |
| [AgentAI][AgentAI]                               | ❌          | ❌        | ✅      | ❓                     | ❌         | ❌    | ❓            | ❓          | ❓          | ❓          |
...
[STDIO]: /docs/concepts/transports#stdio
[SSE]: /docs/concepts/transports#sse
[Streamable HTTP]: /docs/concepts/transports#streamable-http
