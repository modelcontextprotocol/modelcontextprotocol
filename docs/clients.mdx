...
- Connect to MCP servers from [Rust](https://crates.io/crates/stdiobus), [Node.js](https://www.npmjs.com/package/@stdiobus/node), [Python](https://pypi.org/project/stdiobus/), C++, and Go using dedicated SDKs.
