---
title: "SEP-2636: Tool Manifests for Incremental Catalog Synchronization"
sidebarTitle: "SEP-2636: Tool Manifests for Incremental Catalog…"
description: "Tool Manifests for Incremental Catalog Synchronization"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 2636                                                                            |
| **Title**     | Tool Manifests for Incremental Catalog Synchronization                          |
| **Status**    | Draft                                                                           |
| **Type**      | Standards Track                                                                 |
| **Created**   | 2026-04-21                                                                      |
| **Author(s)** | Sai Prakash ([@SylonZero](https://github.com/SylonZero))                        |
| **Sponsor**   | None (seeking sponsor)                                                          |
| **PR**        | [#2636](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2636) |
