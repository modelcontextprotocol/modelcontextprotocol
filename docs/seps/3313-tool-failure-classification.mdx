---
title: "SEP-3313: Structured Tool-Failure Classification (`ToolFailure`)"
sidebarTitle: "SEP-3313: Structured Tool-Failure Classification…"
description: "Structured Tool-Failure Classification (`ToolFailure`)"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 3313                                                                            |
| **Title**     | Structured Tool-Failure Classification (`ToolFailure`)                          |
| **Status**    | Draft                                                                           |
| **Type**      | Standards Track                                                                 |
| **Created**   | 2026-08-27                                                                      |
| **Author(s)** | John Zaguirre ([@johnyzaguirre-glean](https://github.com/johnyzaguirre-glean))  |
| **Sponsor**   | None (seeking sponsor)                                                          |
| **PR**        | [#3313](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/3313) |
