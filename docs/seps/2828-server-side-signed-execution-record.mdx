---
title: "SEP-2828: Server-Side Signed Execution Record for MCP Tool Calls"
sidebarTitle: "SEP-2828: Server-Side Signed Execution Record for…"
description: "Server-Side Signed Execution Record for MCP Tool Calls"
---
...
<div className="flex items-center gap-2 mb-4">
  ...
  <Badge color="gray" shape="pill">
    Standards Track (Extensions Track)
  </Badge>
</div>
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 2828                                                                            |
| **Title**     | Server-Side Signed Execution Record for MCP Tool Calls                          |
| **Status**    | Draft                                                                           |
| **Type**      | Standards Track (Extensions Track)                                              |
| **Created**   | 2026-05-31                                                                      |
| **Author(s)** | Henri Sirkkavaara ([@vaaraio](https://github.com/vaaraio)), Vaara               |
| **Sponsor**   | None (seeking sponsor)                                                          |
| **PR**        | [#2828](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2828) |
