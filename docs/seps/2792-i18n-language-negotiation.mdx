---
title: "SEP-2792: Per-Request User Language Preference"
sidebarTitle: "SEP-2792: Per-Request User Language Preference"
description: "Per-Request User Language Preference"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 2792                                                                            |
| **Title**     | Per-Request User Language Preference                                            |
| **Status**    | Draft                                                                           |
| **Type**      | Standards Track                                                                 |
| **Created**   | 2026-05-26                                                                      |
| **Author(s)** | Sam Morrow ([@SamMorrowDrums](https://github.com/SamMorrowDrums))               |
| **Sponsor**   | Peter Alexander ([@pja-ant](https://github.com/pja-ant))                        |
| **PR**        | [#2792](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2792) |
