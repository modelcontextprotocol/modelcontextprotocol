---
title: "SEP-2792: Internationalization via Per-Request Language Negotiation"
sidebarTitle: "SEP-2792: Internationalization via Per-Request La…"
description: "Internationalization via Per-Request Language Negotiation"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 2792                                                                            |
| **Title**     | Internationalization via Per-Request Language Negotiation                       |
| **Status**    | Draft                                                                           |
