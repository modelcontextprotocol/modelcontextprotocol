...
**`docs/specification/draft/features/deprecated/roots.mdx`:**
...
**`docs/specification/draft/features/deprecated/sampling.mdx`:**
...
**`docs/specification/draft/features/deprecated/logging.mdx`:**
