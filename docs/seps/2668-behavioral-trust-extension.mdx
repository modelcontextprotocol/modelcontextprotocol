---
title: "SEP-2668: Behavioral Trust Extension for MCP Registry"
sidebarTitle: "SEP-2668: Behavioral Trust Extension for MCP Regi…"
description: "Behavioral Trust Extension for MCP Registry"
---

<div className="flex items-center gap-2 mb-4">
  <Badge color="gray" shape="pill">Unknown</Badge>
  <Badge color="gray" shape="pill">Unknown</Badge>
</div>
...
|-------|-------|
| **SEP** | 2668 |
| **Title** | Behavioral Trust Extension for MCP Registry |
| **Status** | Unknown |
| **Type** | Unknown |
| **Created** | Unknown |
| **Author(s)** | Unknown |
| **Sponsor** | None |
| **PR** | [#2668](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2668) |
