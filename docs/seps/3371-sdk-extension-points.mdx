---
title: "SEP-3371: Consistent SDK Extension Points"
sidebarTitle: "SEP-3371: Consistent SDK Extension Points"
description: "Consistent SDK Extension Points"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 3371                                                                            |
| **Title**     | Consistent SDK Extension Points                                                 |
| **Status**    | Draft                                                                           |
| **Type**      | Standards Track                                                                 |
| **Created**   | 2026-09-18                                                                      |
| **Author(s)** | Sambhav Kothari ([@sambhav](https://github.com/sambhav))                        |
| **Sponsor**   | Felix Weinberger ([@felixweinberger](https://github.com/felixweinberger))       |
| **PR**        | [#3371](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/3371) |
