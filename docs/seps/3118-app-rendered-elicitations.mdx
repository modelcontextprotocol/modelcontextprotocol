---
title: "SEP-3118: App-Rendered Elicitations for MCP Apps"
sidebarTitle: "SEP-3118: App-Rendered Elicitations for MCP Apps"
description: "App-Rendered Elicitations for MCP Apps"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 3118                                                                            |
| **Title**     | App-Rendered Elicitations for MCP Apps                                          |
| **Status**    | Draft                                                                           |
| **Type**      | Extensions Track                                                                |
| **Created**   | 2026-07-22                                                                      |
| **Author(s)** | Kyle Rubenok ([@krubenok](https://github.com/krubenok))                         |
| **Sponsor**   | None (seeking sponsor)                                                          |
| **PR**        | [#3118](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/3118) |
