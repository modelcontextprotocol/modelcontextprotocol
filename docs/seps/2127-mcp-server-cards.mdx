---
title: "SEP-2127: MCP Server Cards - HTTP Server Discovery"
sidebarTitle: "SEP-2127: MCP Server Cards - HTTP Server Discovery"
description: "MCP Server Cards - HTTP Server Discovery"
---
...
Where the formats cover the same concepts, such as identity, documentation, and remote endpoints, they use compatible metadata where practical. A Registry entry can reference or embed a card's remote information.
