---
title: "SEP-2395: Cryptographic Security Layer for MCP"
sidebarTitle: "SEP-2395: Cryptographic Security Layer for MCP"
description: "Cryptographic Security Layer for MCP"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 2395                                                                            |
| **Title**     | Cryptographic Security Layer for MCP                                            |
| **Status**    | Draft                                                                           |
