---
title: "SEP-2145: Standardize `tools/call` Failure Reporting"
sidebarTitle: "SEP-2145: Standardize `tools/call` Failure Report…"
description: "Standardize `tools/call` Failure Reporting"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 2145                                                                            |
| **Title**     | Standardize `tools/call` Failure Reporting                                      |
| **Status**    | Draft                                                                           |
| **Type**      | Standards Track                                                                 |
| **Created**   | 2026-01-23                                                                      |
| **Author(s)** | Konstantin Konstantinov ([@KKonstantinov](https://github.com/KKonstantinov))    |
| **Sponsor**   | None                                                                            |
| **PR**        | [#2145](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2145) |
