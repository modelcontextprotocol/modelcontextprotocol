---
title: "SEP-3279: Negotiated tool result variants"
sidebarTitle: "SEP-3279: Negotiated tool result variants"
description: "Negotiated tool result variants"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 3279                                                                            |
| **Title**     | Negotiated tool result variants                                                 |
| **Status**    | Draft                                                                           |
| **Type**      | Standards Track                                                                 |
| **Created**   | 2026-08-18                                                                      |
| **Author(s)** | Kyle Rubenok ([@krubenok](https://github.com/krubenok))                         |
| **Sponsor**   | None (seeking sponsor)                                                          |
| **PR**        | [#3279](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/3279) |
