---
title: "SEP-2624: Interceptors for Model Context Protocol"
sidebarTitle: "SEP-2624: Interceptors for Model Context Protocol"
description: "Interceptors for Model Context Protocol"
---
...
| ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **SEP**       | 2624                                                                                                                                                                                     |
| **Title**     | Interceptors for Model Context Protocol                                                                                                                                                  |
| **Status**    | Draft                                                                                                                                                                                    |
| **Type**      | Standards Track                                                                                                                                                                          |
| **Created**   | 2025-11-04                                                                                                                                                                               |
| **Author(s)** | Sambhav Kothari ([@sambhav](https://github.com/sambhav)), Kurt Degiorgio ([@Degiorgio](https://github.com/Degiorgio)), Peder Holdgaard Pedersen ([@PederHP](https://github.com/PederHP)) |
| **Sponsor**   | Sambhav Kothari ([@sambhav](https://github.com/sambhav))                                                                                                                                 |
