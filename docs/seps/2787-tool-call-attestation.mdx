---
title: "SEP-2787: Tool Call Attestation"
sidebarTitle: "SEP-2787: Tool Call Attestation"
description: "Tool Call Attestation"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 2787                                                                            |
| **Title**     | Tool Call Attestation                                                           |
| **Status**    | Draft                                                                           |
| **Type**      | Extensions Track                                                                |
| **Created**   | 2026-05-23                                                                      |
| **Author(s)** | heysoup.co Team                                                                 |
| **Sponsor**   | None (seeking sponsor)                                                          |
| **PR**        | [#2787](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2787) |
