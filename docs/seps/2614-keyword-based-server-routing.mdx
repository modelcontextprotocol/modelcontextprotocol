---
title: "SEP-2614: Keyword-based Server Routing via `Implementation.keywords`"
sidebarTitle: "SEP-2614: Keyword-based Server Routing via `Imple…"
...
| **PR**        | [#2614](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2614) |
