---
title: "SEP-3304: Standardize Rate-Limiting Errors"
sidebarTitle: "SEP-3304: Standardize Rate-Limiting Errors"
description: "Standardize Rate-Limiting Errors"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 3304                                                                            |
| **Title**     | Standardize Rate-Limiting Errors                                                |
| **Status**    | Draft                                                                           |
| **Type**      | Standards Track                                                                 |
| **Created**   | 2026-08-25                                                                      |
| **Author(s)** | Stephen Tyree ([@tyree731](https://github.com/tyree731))                        |
| **Sponsor**   | None (seeking sponsor)                                                          |
| **PR**        | [#3304](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/3304) |
