---
title: "SEP-2679: Task Streaming — Partial Results for Long-Running Operations"
sidebarTitle: "SEP-2679: Task Streaming — Partial Results for Lo…"
description: "Task Streaming — Partial Results for Long-Running Operations"
---
...
| ------------- | ---------------------------------------------------------------------------------------------- |
| **SEP**       | 2679                                                                                           |
| **Title**     | Task Streaming — Partial Results for Long-Running Operations                                   |
| **Status**    | Draft                                                                                          |
| **Type**      | Standards Track                                                                                |
| **Created**   | 2026-05-03                                                                                     |
| **Author(s)** | Raman Marozau <raman[@stdiobus](https://github.com/stdiobus).com> (https://github.com/morozow) |
