---
title: "SEP-3263: Multi-Party Action Security (MPAS) for MCP"
sidebarTitle: "SEP-3263: Multi-Party Action Security (MPAS) for…"
description: "Multi-Party Action Security (MPAS) for MCP"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 3263                                                                            |
| **Title**     | Multi-Party Action Security (MPAS) for MCP                                      |
| **Status**    | Draft                                                                           |
| **Type**      | Extensions Track                                                                |
| **Created**   | 2026-08-14                                                                      |
| **Author(s)** | OMA3 DAO ([@oma3dao](https://github.com/oma3dao))                               |
| **Sponsor**   | None (seeking sponsor)                                                          |
| **PR**        | [#3263](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/3263) |
