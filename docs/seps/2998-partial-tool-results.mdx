---
title: "SEP-2998: Partial Tool Results (Streaming Tool Call Output)"
sidebarTitle: "SEP-2998: Partial Tool Results (Streaming Tool Ca…"
description: "Partial Tool Results (Streaming Tool Call Output)"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 2998                                                                            |
| **Title**     | Partial Tool Results (Streaming Tool Call Output)                               |
| **Status**    | Draft                                                                           |
| **Type**      | Standards Track                                                                 |
| **Created**   | 2026-07-01                                                                      |
| **Author(s)** | Iyad Kuwatly ([@Kuwatly](https://github.com/Kuwatly))                           |
| **Sponsor**   | None (seeking)                                                                  |
| **PR**        | [#2998](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2998) |
