---
title: "SEP-0000: MCPS — Cryptographic Security Layer for MCP"
sidebarTitle: "SEP-0000: MCPS — Cryptographic Security Layer for…"
description: "MCPS — Cryptographic Security Layer for MCP"
---
...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **SEP**       | 0000                                                                                                                                                   |
| **Title**     | MCPS — Cryptographic Security Layer for MCP                                                                                                            |
| **Status**    | Draft                                                                                                                                                  |
| **Type**      | Standards Track                                                                                                                                        |
| **Created**   | 2026-03-13                                                                                                                                             |
| **Author(s)** | Raza Sharif <contact[@agentsign](https://github.com/agentsign).dev> ([@razashariff](https://github.com/razashariff))                                   |
| **Sponsor**   | None (seeking sponsor — cc [@pcarleton](https://github.com/pcarleton) [@dsp-ant](https://github.com/dsp-ant) [@nickcoai](https://github.com/nickcoai)) |
