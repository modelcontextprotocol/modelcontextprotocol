...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ------------------------------------------------- | ---------------- | ---------- |
| [SEP-2495](/seps/2495-event-driven-tool-invocation)                                  | Event-Driven Tool Invocation (Server-Push to LLM Re-entry)                    | <Badge color="gray" shape="pill">Draft</Badge>    | Standards Track  | 2026-03-29 |
