...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ------------------------------------------------- | ---------------- | ---------- |
| [SEP-2678](/seps/2678-standardize-implementation-specific-error-codes)               | Standardize Implementation-Specific JSON-RPC Error Codes                      | <Badge color="gray" shape="pill">Draft</Badge>    | Standards Track  | 2026-05-04 |
