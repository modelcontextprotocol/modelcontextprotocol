...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ------------------------------------------------- | ---------------- | ---------- |
| [SEP-2395](/seps/2395-mcps-cryptographic-security-layer)                             | Cryptographic Security Layer for MCP                                          | <Badge color="gray" shape="pill">Draft</Badge>    | Standards Track  | 2026-03-13 |
