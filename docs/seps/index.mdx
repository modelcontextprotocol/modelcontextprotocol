...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ---------------------------------------------------- | ---------------- | ---------- |
| [SEP-2752](/seps/2752-http-message-signing-for-mcp-client-authentication)            | HTTP Message Signing for MCP Client Authentication                            | <Badge color="gray" shape="pill">Draft</Badge>       | Extensions Track | 2026-05-19 |
