...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ----------------------------------------------- | ---------------- | ---------- |
| [SEP-2998](/seps/2998-partial-tool-results)                                          | Partial Tool Results (Streaming Tool Call Output)                             | <Badge color="gray" shape="pill">Draft</Badge>  | Standards Track  | 2026-07-01 |
