...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ------------------------------------------------- | ---------------- | ---------- |
| [SEP-2631](/seps/2631-file-objects-and-transfer)                                     | File Objects and Transfer                                                     | <Badge color="gray" shape="pill">Draft</Badge>    | Standards Track  | 2026-04-20 |
| [SEP-2356](/seps/2356-declarative-file-inputs-for-tools-and-elicitation)             | Declarative File Inputs for Tools and Elicitation                             | <Badge color="gray" shape="pill">Draft</Badge>    | Standards Track  | 2026-03-04 |
