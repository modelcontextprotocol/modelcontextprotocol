...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ------------------------------------------------- | ---------------- | ---------- |
| [SEP-2624](/seps/2624-interceptors-for-model-context-protocol)                       | Interceptors for Model Context Protocol                                       | <Badge color="gray" shape="pill">Draft</Badge>    | Standards Track  | 2025-11-04 |
