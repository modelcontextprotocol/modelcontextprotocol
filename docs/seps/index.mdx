...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ----------------------------------------------- | ---------------- | ---------- |
| [SEP-3004](/seps/3004-tamper-evident-audit-record-contract)                          | Tamper-Evident Audit Record Contract                                          | <Badge color="gray" shape="pill">Draft</Badge>  | Standards Track  | 2026-06-02 |
