...
| [SEP-2145](/seps/2145-standardize-tools-call-failure-reporting)                      | Standardize `tools/call` Failure Reporting                                    | <Badge color="gray" shape="pill">Draft</Badge>    | Standards Track  | 2026-01-23 |
