...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ------------------------------------------------- | ---------------- | ---------- |
| [SEP-2614](/seps/2614-keyword-based-server-routing)                                  | Keyword-based Server Routing via `Implementation.keywords`                    | <Badge color="gray" shape="pill">Draft</Badge>    | Standards Track  | 2026-04-20 |
