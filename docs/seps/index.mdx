...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | --------------------------------------------------------- | ---------------- | ---------- |
| [SEP-3318](/seps/3318-verifiable-conversation-handles)                               | Verifiable Conversation Handles                                               | <Badge color="gray" shape="pill">Awaiting Sponsor</Badge> | Standards Track  | 2026-08-26 |
