...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ----------------------------------------------- | ---------------- | ---------- |
| [SEP-3118](/seps/3118-app-rendered-elicitations)                                     | App-Rendered Elicitations for MCP Apps                                        | <Badge color="gray" shape="pill">Draft</Badge>  | Extensions Track | 2026-07-22 |
