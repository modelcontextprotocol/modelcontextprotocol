...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ------------------------------------------------- | ---------------- | ---------- |
| [SEP-2293](/seps/2293-enhanced-completion-values)                                    | Enhanced Completion Values with Rich Metadata Support                         | <Badge color="gray" shape="pill">Draft</Badge>    | Standards Track  | 2025-09-08 |
