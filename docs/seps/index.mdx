...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ----------------------------------------------- | ---------------- | ---------- |
| [SEP-3313](/seps/3313-tool-failure-classification)                                   | Structured Tool-Failure Classification (`ToolFailure`)                        | <Badge color="gray" shape="pill">Draft</Badge>  | Standards Track  | 2026-08-27 |
