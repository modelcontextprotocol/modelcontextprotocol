...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ---------------------------------------------------- | ---------------- | ---------- |
| [SEP-2809](/seps/2809-attested-tool-server-admission)                                | Attested Tool-Server Admission (ATSA)                                         | <Badge color="gray" shape="pill">Draft</Badge>       | Standards Track  | 2026-05-22 |
