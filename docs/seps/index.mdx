...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ------------------------------------------------- | ---------------- | ---------- |
| [SEP-2672](/seps/2672-per-call-passkey-verified-approval-for-mcp-tool-calls)         | Per-Call Passkey Verified Approval for MCP Tool Calls                         | <Badge color="gray" shape="pill">Draft</Badge>    | Standards Track  | 2026-05-02 |
