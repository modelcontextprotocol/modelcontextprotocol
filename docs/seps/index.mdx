...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ------------------------------------------------- | ---------------- | ---------- |
| [SEP-2557](/seps/2557-adapt-tasks-for-stateless-and-sessionless-protocol)            | Adapt Tasks for Stateless & Sessionless Protocol                              | <Badge color="gray" shape="pill">Draft</Badge>    | Standards Track  | 2026-04-12 |
