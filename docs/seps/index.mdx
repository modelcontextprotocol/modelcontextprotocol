...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ------------------------------------------------- | ---------------- | ---------- |
| [SEP-2521](/seps/2521-remote-server-deployment-guidelines)                           | Remote Server Deployment Guidelines                                           | <Badge color="gray" shape="pill">Draft</Badge>    | Informational    | 2026-04-05 |
