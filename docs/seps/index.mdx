...
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- | ----------------------------------------------- | ---------------- | ---------- |
| [SEP-3149](/seps/3149-require-token-endpoint-auth-methods-supported-in-cimd)         | Require `token_endpoint_auth_methods_supported` in Client ID Metadata Documents | <Badge color="gray" shape="pill">Draft</Badge>  | Standards Track  | 2026-07-27 |
