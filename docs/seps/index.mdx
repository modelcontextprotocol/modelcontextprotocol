...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ---------------------------------------------------- | ---------------- | ---------- |
| [SEP-2792](/seps/2792-i18n-language-negotiation)                                     | Internationalization via Per-Request Language Negotiation                     | <Badge color="gray" shape="pill">Draft</Badge>       | Standards Track  | 2026-05-26 |
