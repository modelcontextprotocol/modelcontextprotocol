...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ---------------------------------------------------- | ---------------- | ---------- |
| [SEP-2817](/seps/2817-ai-invocation-audit-context)                                   | AI Invocation Audit Context in Request `_meta`                                | <Badge color="gray" shape="pill">Draft</Badge>       | Standards Track  | 2026-05-30 |
