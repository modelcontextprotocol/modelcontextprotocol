...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | ------------------------------------------------- | ---------------- | ---------- |
| [SEP-2679](/seps/2679-task-streaming-partial-results)                                | Task Streaming — Partial Results for Long-Running Operations                  | <Badge color="gray" shape="pill">Draft</Badge>    | Standards Track  | 2026-05-03 |
