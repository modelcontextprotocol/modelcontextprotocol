...
| [SEP-2207](/seps/2207-oidc-refresh-token-guidance)                                   | OIDC-Flavored Refresh Token Guidance                                          | <Badge color="yellow" shape="pill">In-Review</Badge> | Standards Track  | 2026-02-04 |
