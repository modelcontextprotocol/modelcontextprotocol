...
| [SEP-2127](/seps/2127-mcp-server-cards)                                              | MCP Server Cards - HTTP Server Discovery via .well-known                      | <Badge color="gray" shape="pill">Draft</Badge>    | Extensions Track | 2026-01-21 |
