---
title: "SEP-2678: Standardize Implementation-Specific JSON-RPC Error Codes"
sidebarTitle: "SEP-2678: Standardize Implementation-Specific JSO…"
description: "Standardize Implementation-Specific JSON-RPC Error Codes"
---
...
| ------------- | ------------------------------------------------------------------------------------------------------------------ |
| **SEP**       | 2678                                                                                                               |
| **Title**     | Standardize Implementation-Specific JSON-RPC Error Codes                                                           |
| **Status**    | Draft                                                                                                              |
| **Type**      | Standards Track                                                                                                    |
| **Created**   | 2026-05-04                                                                                                         |
| **Author(s)** | matthew.khouzam[@ericsson](https://github.com/ericsson).com ([@matthewkhouzam](https://github.com/matthewkhouzam)) |
