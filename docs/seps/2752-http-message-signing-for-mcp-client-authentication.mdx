---
title: "SEP-2752: HTTP Message Signing for MCP Client Authentication"
sidebarTitle: "SEP-2752: HTTP Message Signing for MCP Client Aut…"
description: "HTTP Message Signing for MCP Client Authentication"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 2752                                                                            |
| **Title**     | HTTP Message Signing for MCP Client Authentication                              |
| **Status**    | Draft                                                                           |
| **Type**      | Standards Track                                                                 |
| **Created**   | 2026-05-19                                                                      |
| **Author(s)** | Neeraj Prasad ([@njdawn](https://github.com/njdawn))                            |
| **Sponsor**   | None (seeking sponsor)                                                          |
| **PR**        | [#2752](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2752) |
