...
- Current sampling documentation: `/specification/draft/features/deprecated/sampling.mdx`
- Current elicitation documentation: `/specification/draft/features/elicitation.mdx`
