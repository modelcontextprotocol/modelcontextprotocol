...
### Using Profiles
MCP Servers can declare the profiles they support by referring to their Profile Specification URL. MCP Clients discover which profiles an MCP Server supports and negotiate the right profiles to use. The following section describes how all this happens.
