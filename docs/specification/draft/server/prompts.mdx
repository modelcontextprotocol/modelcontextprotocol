...
Prompts are designed to be **user-initiated**, meaning they are exposed from servers to
clients with the intention of the user being able to explicitly select them for use.
This describes who invokes the prompt, not who authors it. Prompt content is defined
by the server.
