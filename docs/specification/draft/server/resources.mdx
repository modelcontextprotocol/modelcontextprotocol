...
supports optional prefix filtering and [pagination](/specification/draft/server/utilities/pagination).
...
This operation supports optional prefix filtering and [pagination](/specification/draft/server/utilities/pagination).
