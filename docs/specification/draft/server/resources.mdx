...
Clients **SHOULD** respect the timeout declared by the server in its `resources.timeouts.list`
capability, or use the protocol default of 60 seconds if not specified.
...
Clients **SHOULD** respect the timeout declared by the server in its `resources.timeouts.read`
capability, or use the protocol default of 30 seconds if not specified.
...
Clients **SHOULD** respect the timeout declared by the server in its `resources.timeouts.subscribe`
capability, or use the protocol default of 30 seconds if not specified.
