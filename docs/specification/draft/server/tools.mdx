...
1. **Protocol Errors**: Standard JSON-RPC errors for issues like:
   - Unknown tools — error code `-32602` ("Invalid params")
   - Malformed requests (requests that fail to satisfy [CallToolRequest schema](/specification/draft/schema#calltoolrequest)) — error code `-32602` ("Invalid params")
   - Server errors — error code `-32603` ("Internal error")
