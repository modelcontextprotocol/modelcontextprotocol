...
Clients **MAY** use the notification to resume queued requests or update their user
interface, but the absence of a notification must not block user progress entirely.
