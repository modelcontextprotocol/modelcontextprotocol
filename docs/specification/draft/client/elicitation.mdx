...
Clients **MAY** use the notification to automatically retry requests that received an [ElicitationRequired error](#error-handling) error, update the user interface, or otherwise continue an interaction.
