...
Servers **SHOULD** respect the timeout declared by the client in its `elicitation.timeouts.create`
capability, or use the protocol default of 600 seconds if not specified. This extended
timeout accommodates the time needed for human interaction.
