...
[pagination](/specification/draft/features/pagination) and [caching](/specification/draft/features/caching).
...
<Note>
  ...
  support optional
  [annotations](/specification/draft/features/resources#annotations) that provide
...
A tool **MAY** return links to [Resources](/specification/draft/features/resources), to provide additional context
...
Resource links support the same [Resource annotations](/specification/draft/features/resources#annotations) as regular resources to help clients understand how to use them.
...
[Resources](/specification/draft/features/resources) **MAY** be embedded to provide additional context
...
Embedded resources support the same [Resource annotations](/specification/draft/features/resources#annotations) as regular resources to help clients understand how to use them.
