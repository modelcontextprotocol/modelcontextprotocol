...
![Example of resource context picker](/specification/draft/features/resource-picker.png)
...
supports [caching](/specification/draft/features/caching).
...
This operation supports [pagination](/specification/draft/features/pagination) and [caching](/specification/draft/features/caching).
