...
![Example of prompt exposed as slash command](/specification/draft/features/slash-command.png)
...
supports [pagination](/specification/draft/features/pagination) and [caching](/specification/draft/features/caching).
...
auto-completed through [the completion API](/specification/draft/features/completion).
...
<Note>
  ...
  [annotations](/specification/draft/features/resources#annotations) for metadata
...
[Resources](/specification/draft/features/resources), to provide additional context or
...
Resource links support the same [Resource annotations](/specification/draft/features/resources#annotations)
