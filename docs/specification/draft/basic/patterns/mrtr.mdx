...
| ----------------------------------------------------------------------------- | ---------------------------- |
| [`prompts/get`](/specification/draft/features/prompts#getting-a-prompt)       | Yes                          |
| [`resources/read`](/specification/draft/features/resources#reading-resources) | Yes                          |
| [`tools/call`](/specification/draft/features/tools#calling-tools)             | Yes                          |
