...
The Model Context Protocol includes a ping mechanism that allows either party
may use to verify that their counterpart is still responsive and the connection is alive.
