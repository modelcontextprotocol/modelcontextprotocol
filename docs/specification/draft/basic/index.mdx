...
Client implementations **SHOULD** use the following format by default for their
...
The first component of the user agent contains any applicable client name and version.
Client implementations **MAY** use a different product name if
...
version. The optional `lang` component contains the client's programming language and optional
...
using Node.js `v22.13.1`. In that scenario, the client might have the following user agent:
