...
MCP provides a [Payment](/specification/draft/basic/payment) framework for premium features using various payment protocols, with X402 Protocol v2 as the recommended first protocol.
