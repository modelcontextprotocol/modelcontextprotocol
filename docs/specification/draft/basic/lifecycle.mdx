...
Example client capabilities with extensions — here a client advertises the
[MCP Apps extension](/extensions/apps/overview)
([SEP-1865](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/1865)),
identified as `io.modelcontextprotocol/ui` and specified in the
[ext-apps repository](https://github.com/modelcontextprotocol/ext-apps), which
lets servers deliver interactive user interfaces that hosts render alongside
tool results:
...
Example server capabilities with extensions — here a server advertises the
[Tasks extension](/extensions/tasks/overview)
([SEP-2663](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2663)),
identified as `io.modelcontextprotocol/tasks`:
