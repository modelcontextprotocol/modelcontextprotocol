...
| -------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| Client   | `roots`        | Ability to provide filesystem [roots](/specification/draft/client/roots) including remote proxy access                         |
...
| Server   | `roots`        | Requires filesystem access and supports [remote proxy connections](/specification/draft/client/roots#remote-filesystem-access) |
