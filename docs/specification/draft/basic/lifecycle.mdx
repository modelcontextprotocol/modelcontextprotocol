...
| -------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| Client   | `roots`        | Ability to provide filesystem [roots](/specification/draft/client/roots) including brokered filesystem access                              |
...
| Server   | `roots`        | Requests filesystem access and supports [brokered filesystem operations](/specification/draft/client/roots#brokered-filesystem-operations) |
