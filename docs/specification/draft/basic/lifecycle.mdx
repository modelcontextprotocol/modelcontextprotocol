...
The value for each extension is an optional configuration object specific to that extension. An empty object `{}` indicates support for the extension without additional configuration.
