...
- The client launches the MCP server as a subprocess, creating a dedicated stdio channel
  and ensuring a strict one-to-one relationship between each client and its server instance.
