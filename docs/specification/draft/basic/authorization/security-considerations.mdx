...
This document outlines a set of considerations that implementers **MUST** consider for their clients
and servers.

Additionally, implementors **MUST** follow OAuth 2.1 security best practices as laid out in
...
When implementing [Client ID Metadata Documents](/specification/draft/basic/authorization/client-id-metadata-documents), authorization servers **MUST** consider the security implications
