...
resource server or a separate entity. The [Authorization Server Discovery section](/specification/draft/basic/authorization/server-discovery)
...
See [Authorization Server Discovery](/specification/draft/basic/authorization/server-discovery)
to learn how MCP servers advertise their authorization servers and how MCP clients discover
authorization server endpoints and capabilities.
