...
For these authorization servers, MCP clients **SHOULD** allow for support supplying static credentials such as those supplied by a preregistration flow. This could be:
