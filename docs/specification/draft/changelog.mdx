...
11. Remove the `notifications/elicitation/complete` notification, introduced in
    `2025-11-25` for URL mode elicitation. Under the
    ...
    request, so a server-initiated completion signal no longer fits the protocol.
