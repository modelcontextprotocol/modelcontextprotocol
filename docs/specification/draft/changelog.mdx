...
5. Add remote filesystem access via pluggable proxy wrapper for MCP roots ([SEP-1708](https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1708))
