...
5. Add brokered filesystem access over existing MCP transport for roots ([SEP-1708](https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1708))
