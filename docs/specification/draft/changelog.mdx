...
11. Define an [error code allocation policy](/specification/draft/basic/index#error-codes)
    partitioning the JSON-RPC server-error range: `-32000` to `-32009` remains
    implementation-defined (existing SDK usage is grandfathered), `-32010` to `-32099` is
