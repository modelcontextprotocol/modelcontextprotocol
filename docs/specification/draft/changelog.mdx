...
2. Allow servers to expose icons as additional metadata for tools, resources and prompts [SEP-973](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/955/files).
