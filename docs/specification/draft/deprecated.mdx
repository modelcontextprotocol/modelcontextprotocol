...
[feature lifecycle and deprecation policy](/seps/2596-spec-feature-lifecycle-and-deprecation)
...
| --------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------- |
| [Roots](/specification/draft/client/roots)                                                                      | [SEP-2577](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2577) | `DRAFT-2026-v1` | Pass directories or files via tool parameters, resource URIs, or server configuration                  | First revision released at least twelve months after this revision's release                          |
| [Sampling](/specification/draft/client/sampling)                                                                | [SEP-2577](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2577) | `DRAFT-2026-v1` | Integrate directly with LLM provider APIs                                                              | First revision released at least twelve months after this revision's release                          |
| [Logging](/specification/draft/server/utilities/logging)                                                        | [SEP-2577](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2577) | `DRAFT-2026-v1` | Log to `stderr` for stdio transports; use [OpenTelemetry](https://opentelemetry.io/) for observability | First revision released at least twelve months after this revision's release                          |
...
as Deprecated under its [transition provisions](/seps/2596-spec-feature-lifecycle-and-deprecation#transition).
