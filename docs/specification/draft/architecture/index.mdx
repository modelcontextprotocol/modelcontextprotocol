...
[`server/discover`](/specification/draft/features/discover), which clients may call before
...
- Implemented [features](/specification/draft/features) must be advertised in the
...
- [Tool](/specification/draft/features/tools) invocation requires the server to declare tool capabilities
- [Sampling](/specification/draft/features/deprecated/sampling) requires the client to declare support in its
  capabilities
