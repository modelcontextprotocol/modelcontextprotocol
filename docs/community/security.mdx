...
The [Security Interest Group](/community/interest-groups/security) is where you raise MCP-specific
security topics, including disclosure questions that don't fit a single repository, and where
facilitators route them to the group that owns the work.
