...
The [Security Interest Group](/community/interest-groups/security) is the venue for raising
MCP-specific security topics and getting them routed to the group that owns them.
