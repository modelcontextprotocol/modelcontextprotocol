...
**There are no formal requirements.** We welcome all contributions.
...
- Sponsored by two existing Members, Reviewers, or Maintainers from different organizations, **or**
...
- Primary reviewer for at least 5 substantial PRs in the scope area
- Reviewed at least 15 PRs total in the scope area
- Working understanding of how MCP integrates with AI systems and model capabilities
- Knowledge of code quality, testing standards, and design patterns
- Good judgment and constructive feedback in reviews

**Sponsorship:**

- Sponsored by an existing Maintainer in the scope area, **or**
...
- Escalate design or architecture concerns to Maintainers
- Respond within the community SLO (typically 48-72 hours for initial response)

**Privileges:**

- Listed in `REVIEWERS.md` for the scope area
...
All contribution pathways can lead to Reviewer. The specific scope will align with the contribution type.
...
**Relationship to Contributor Ladder:** Community Moderator is a parallel track, not a prerequisite for technical advancement. Moderator experience counts toward any role, especially where community judgment matters. Moderators may hold other roles at the same time (Reviewer, Maintainer, etc.).
