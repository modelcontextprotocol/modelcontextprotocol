---
title: Filesystems Charter
description: Charter for the MCP Filesystems Working Group.
---
...
| --------------- | ------------ | ---------------------------------------------------- | --------- | --------- |
| Daniel Temesgen | Bloomberg    | [@DanielTemesgen](https://github.com/DanielTemesgen) | dtemesgen | WG Member |
