...
Full live tracking is on the [Skills Over MCP WG project board](https://github.com/orgs/modelcontextprotocol/projects/38/views/1).
SDK implementations and host support are tracked in the [implementations list](https://github.com/modelcontextprotocol/ext-skills/blob/main/docs/implementations.md);
publication of the specification does not imply support in every SDK or client.

| Item                                               | Status      | Target Date | Champion                                                                                     |
| -------------------------------------------------- | ----------- | ----------- | -------------------------------------------------------------------------------------------- |
| Skills Extension SDK and reference implementations | In Progress |             | [@olaservo](https://github.com/olaservo)                                                     |
