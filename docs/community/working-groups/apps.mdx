...
| ------------------------------------------------------------------------------------------------------------------------------------------------ | ----------- | ----------- | -------------------------------------------------------------------------------------- |
| Specification and SDK evolution: protocol alignment, capability negotiation, versioning, and maintenance of `@modelcontextprotocol/ext-apps`     | In Progress |             | [@idosal](https://github.com/idosal), [@liady](https://github.com/liady)               |
| Address view sprawl across tools and servers (reusable and independent views)                                                                    | In Progress |             | [@mstoiber-oai](https://github.com/mstoiber-oai), [@idosal](https://github.com/idosal) |
...
| Dynamic content with embedded resources                                                                                                          | Draft       |             | [@liady](https://github.com/liady)                                                     |
...
| Developer experience and ecosystem adoption: reference host, authoring tools, examples, documentation, accessibility, and discovery coordination | Maintained  |             | TBD                                                                                    |
...
- MCP Apps is the standard UI layer of the agentic web across MCP hosts.
