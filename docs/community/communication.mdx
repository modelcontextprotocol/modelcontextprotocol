...
| [GitHub Issues](https://github.com/modelcontextprotocol/modelcontextprotocol/issues)              | Actionable tasks      | Bug reports, feature requests, documentation fixes |
| [SECURITY.md](https://github.com/modelcontextprotocol/modelcontextprotocol/blob/main/SECURITY.md) | Security issues       | Vulnerabilities - never post publicly              |
...
Use for bug reports, feature tracking, and actionable development tasks.
