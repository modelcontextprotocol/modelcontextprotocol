...
**Goal**: facilitate MCP community collaboration on a specific SEP or themed series of SEPs. Time-bound: successful WGs will eventually be retired when they are “done”.

**Expectations**:

* Minimum monthly progress towards at least one SEP or spec-related implementation
