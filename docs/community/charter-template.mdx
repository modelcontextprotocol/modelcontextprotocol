...
<!--
List current group members and their participation levels (Observer,
Participant, WG Member). Participation tiers and membership criteria are
defined in the governance rules.

For a newly formed group, list the initial Participants — WG Member status is
established through sustained participation.
-->
