...
This policy applies to MCP meetings, working groups, interest groups, and any other project forum where competitors may be present. See [Meetings and channels](/community/working-interest-groups#meetings-and-channels) for how group meetings are run.
