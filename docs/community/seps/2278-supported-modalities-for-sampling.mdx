---
title: "SEP-2278: Supported Modalities for Sampling"
sidebarTitle: "SEP-2278: Supported Modalities for Sampling"
description: "Supported Modalities for Sampling"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 2278                                                                            |
| **Title**     | Supported Modalities for Sampling                                               |
| **Status**    | Draft                                                                           |
| **Type**      | Standards Track                                                                 |
| **Created**   | 2026-02-19                                                                      |
| **Author(s)** | Alex Hancock ([@alexhancock](https://github.com/alexhancock))                   |
| **Sponsor**   | (seeking sponsor)                                                               |
| **PR**        | [#2278](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2278) |
