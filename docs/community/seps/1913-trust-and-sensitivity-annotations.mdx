---
title: "SEP-1913: Trust and Sensitivity Annotations"
sidebarTitle: "SEP-1913: Trust and Sensitivity Annotations"
description: "Trust and Sensitivity Annotations"
---
...
| ------------- | --------------------------------------------------------------------------------------------------------------------------- |
| **SEP**       | 1913                                                                                                                        |
| **Title**     | Trust and Sensitivity Annotations                                                                                           |
| **Status**    | Draft                                                                                                                       |
| **Type**      | Standards Track                                                                                                             |
| **Created**   | 2025-06-11                                                                                                                  |
| **Author(s)** | Sam Morrow ([@SamMorrowDrums](https://github.com/SamMorrowDrums)), Rob Reichel ([@rreichel3](https://github.com/rreichel3)) |
| **Sponsor**   | [@dend](https://github.com/dend)                                                                                            |
| **PR**        | [#1913](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/1913)                                             |
