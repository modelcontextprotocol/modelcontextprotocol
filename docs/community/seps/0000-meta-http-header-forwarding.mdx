---
title: "SEP-0000: Automatic \_meta to HTTP Header Forwarding for Distributed Tracing"
sidebarTitle: "SEP-0000: Automatic \_meta to HTTP Header Forward…"
description: "Automatic \_meta to HTTP Header Forwarding for Distributed Tracing"
---
...
| ------------- | ------------------------------------------------------------------ |
| **SEP**       | 0000                                                               |
| **Title**     | Automatic \_meta to HTTP Header Forwarding for Distributed Tracing |
| **Status**    | Draft                                                              |
| **Type**      | Standards Track                                                    |
| **Created**   | 2025-12-29                                                         |
| **Author(s)** | Manah Khalil ([@monahk](https://github.com/monahk))                |
| **Sponsor**   | None                                                               |
| **PR**        | [#0000](#2028)                                                     |
