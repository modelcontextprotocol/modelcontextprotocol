...
| [SEP-414](/community/seps/414-request-meta)                                         | Document OpenTelemetry Trace Context Propagation Conventions                  | <Badge color="gray">Draft</Badge>  | Standards Track  | 2026-01-20 |
