...
| [SEP-0000](/community/seps/0000-https-url-resource-access)                          | Out-of-Band Resource Access via HTTPS URLs                                    | <Badge color="gray">Draft</Badge>  | Standards Track  | 2025-01-28 |
