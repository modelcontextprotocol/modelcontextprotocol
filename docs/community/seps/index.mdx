...
| [SEP-1336](/community/seps/1336-user-agent-guidance)                                | User Agent Guidance for Client SDK Implementations                            | <Badge color="gray">Draft</Badge>  | Standards Track  | 2025-08-11 |
