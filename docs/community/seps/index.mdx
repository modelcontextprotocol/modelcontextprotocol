...
| [SEP-0000](/community/seps/0000-meta-http-header-forwarding)                        | Automatic \_meta to HTTP Header Forwarding for Distributed Tracing            | <Badge color="gray">Draft</Badge>  | Standards Track  | 2025-12-29 |
