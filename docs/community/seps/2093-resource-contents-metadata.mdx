---
title: "SEP-2093: Resource Contents Metadata and Resource Capabilities"
sidebarTitle: "SEP-2093: Resource Contents Metadata and Resource…"
description: "Resource Contents Metadata and Resource Capabilities"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 2093                                                                            |
| **Title**     | Resource Contents Metadata and Resource Capabilities                            |
| **Status**    | Draft                                                                           |
| **Type**      | Standards Track                                                                 |
| **Created**   | 2026-01-15                                                                      |
| **Author(s)** | Peter Alexander ([@pja-ant](https://github.com/pja-ant))                        |
| **Sponsor**   | None (seeking sponsor)                                                          |
| **PR**        | [#2093](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2093) |
