---
title: "SEP-2149: MCP Working Group Charter Template"
sidebarTitle: "SEP-2149: MCP Working Group Charter Template"
description: "MCP Working Group Charter Template"
---
...
| ------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| **SEP**       | 2149                                                                                                                         |
| **Title**     | MCP Working Group Charter Template                                                                                           |
| **Status**    | Draft                                                                                                                        |
| **Type**      | Process                                                                                                                      |
| **Created**   | 2025-01-15                                                                                                                   |
