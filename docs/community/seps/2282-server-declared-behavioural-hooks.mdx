---
title: "SEP-2282: Server-Declared Behavioural Hooks"
sidebarTitle: "SEP-2282: Server-Declared Behavioural Hooks"
description: "Server-Declared Behavioural Hooks"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 2282                                                                            |
| **Title**     | Server-Declared Behavioural Hooks                                               |
| **Status**    | Draft                                                                           |
| **Type**      | Standards Track                                                                 |
| **Created**   | 2026-02-21                                                                      |
| **Author(s)** | David Hayes ([@heyhayes](https://github.com/heyhayes))                          |
| **Sponsor**   | None                                                                            |
