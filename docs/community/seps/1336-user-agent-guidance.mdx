---
title: "SEP-1336: User Agent Guidance for Client Implementations"
sidebarTitle: "SEP-1336: User Agent Guidance for Client Implemen…"
description: "User Agent Guidance for Client Implementations"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 1336                                                                            |
| **Title**     | User Agent Guidance for Client Implementations                                  |
| **Status**    | Draft                                                                           |
