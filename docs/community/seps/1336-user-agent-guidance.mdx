---
title: "SEP-1336: User Agent Guidance for Client SDK Implementations"
sidebarTitle: "SEP-1336: User Agent Guidance for Client SDK Impl…"
description: "User Agent Guidance for Client SDK Implementations"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 1336                                                                            |
| **Title**     | User Agent Guidance for Client SDK Implementations                              |
| **Status**    | Draft                                                                           |
| **Type**      | Standards Track                                                                 |
| **Created**   | 2025-08-11                                                                      |
| **Author(s)** | Luca Chang ([@LucaButBoring](https://github.com/LucaButBoring))                 |
| **Sponsor**   | Nick Aldridge ([@000-000-000-000-000](https://github.com/000-000-000-000-000))  |
| **PR**        | [#1336](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/1336) |
