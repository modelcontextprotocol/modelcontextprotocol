---
title: "SEP-0000: MCP Server Identity and Tool Attestation"
sidebarTitle: "SEP-0000: MCP Server Identity and Tool Attestation"
description: "MCP Server Identity and Tool Attestation"
---
...
| ------------- | ------------------------------------------------------------------------------- |
| **SEP**       | 0000                                                                            |
| **Title**     | MCP Server Identity and Tool Attestation                                        |
| **Status**    | Draft                                                                           |
| **Type**      | Extensions Track                                                                |
| **Created**   | 2026-02-17                                                                      |
| **Author(s)** | Abdel Fane ([@abdelsfane](https://github.com/abdelsfane))                       |
