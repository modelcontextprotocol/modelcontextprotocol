...
- **[Git](https://git-scm.com/downloads)** - For version control (available via platform-specific
  package managers or OS distributions) and being able to check out and contribute specification
...
<Note>
While we use the specification repository as an example, the key patterns are applicable to other
MCP repos as well.
</Note>

### Step 1: Set Up Your Environment

First, set up the basics in your **local environment**. This will give you the ability to test and
validate changes without worrying about breaking anything in the production repositories.

<Steps>
  <Step title="Fork the repository">
    Click the **Fork** button on the
    [repository page](https://github.com/modelcontextprotocol/modelcontextprotocol) to create your
    own copy.
  </Step>
...
Once you are ready to have your change reviewed by the MCP maintainer team, you will need to
...
<Tip>
That's it, **congratulations on your first contribution**! Every improvement, no matter how small,
helps make MCP better for everyone.
</Tip>

### What Makes a Good Contribution

As with any contributions, we want to make sure that the team reviews them quickly and is able to
validate the changes. Here are a few examples that will help you make sure that your contribution
is in good shape prior to the review:
...
Different types of contributions may follow different processes. To make sure that we avoid
frustrating back-and-forth conversations, here are some recommended approaches to tackling changes
depending on their scope.

<Tip>
Not sure which category your change falls into? Ask in the
[MCP Contributor Discord](/community/communication#discord) before starting any significant work.
</Tip>
...
the protocol into their applications. Clear documentation lowers the barrier to adoption and
reduces questions in support channels.
...
<Steps>
  ...
  <Step title="Find a sponsor">
    A maintainer from the
    [maintainer list](https://github.com/modelcontextprotocol/modelcontextprotocol/blob/main/MAINTAINERS.md)
...
and servers for their preferred platform. SDK contributions of any kind are highly valued,
regardless of whether you're fixing bugs, improving performance, adding features, or enhancing
documentation.

<Note>
Each SDK has its own repository, maintainers, and contribution guidelines. Some SDKs are
maintained in collaboration with larger partner organizations, such as Google, Microsoft,
JetBrains, and others, so processes may vary slightly between repositories.
</Note>
...
Got questions or need guidance? The MCP community is here to help. Choose the channel that best
fits your needs.
...
- **[GitHub Discussions](https://github.com/modelcontextprotocol/modelcontextprotocol/discussions)**
  \- Longer-form questions and proposals
- **[GitHub Issues](https://github.com/modelcontextprotocol/modelcontextprotocol/issues)** - Bug
  reports and feature requests

For protocol discussions, join [Working Group](/community/working-interest-groups) channels like
`#auth-wg` or `#server-identity-wg`.

For SDK help, find your language's channel (e.g., `#typescript-sdk-dev`).
...
<Warning>
Every SEP needs a sponsor to move forward. SEPs that don't find a sponsor within 6 months are
marked as **dormant**. Dormant SEPs aren't rejected outright - they can be revived later if a
sponsor is found or the proposal is re-assessed to be needed.
</Warning>
...
[community servers list](https://github.com/modelcontextprotocol/servers) by opening a PR to add
your server to the README.
