...
<Steps>
  <Step title="Fork the repository">
    ...
    create your own copy. This gives you a personal workspace where you can make
  ...
  <Step title="Verify everything works">
    ...
    checks, and formatting checks. If everything passes, your environment is good and you're ready
    to contribute.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Commit with a clear message">
    ...
    ```
    Write a concise message that describes what you changed and why. Reference issue numbers if
    applicable (e.g., `Fix typo in tools documentation (#123)`).
  </Step>
</Steps>
