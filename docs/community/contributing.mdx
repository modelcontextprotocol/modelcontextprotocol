...
You don't need to have a change ready to get involved - connecting with the community early is
the best way to find out where help is needed and to get quick answers when you're stuck:

- **[Discord](https://discord.gg/6CSzBmMkjX)** - Join the MCP Contributor Discord for real-time
  discussion with contributors and maintainers. Introduce yourself, follow the channels for the
  areas you care about (e.g., `#typescript-sdk-dev`, `#auth-wg`), and ask questions as you go.
- **[Live calls](https://meet.modelcontextprotocol.io/)** - Attend
  [Working and Interest Group](/community/working-interest-groups) calls to see what's being
  worked on and where you can help.
- **[GitHub Discussions](https://github.com/modelcontextprotocol/modelcontextprotocol/discussions)**
  \- Browse ongoing proposals and roadmap conversations, or start a discussion of your own.

For a complete overview of the available channels and when to use each one, see the
[Contributor Communication](/community/communication) guide.
