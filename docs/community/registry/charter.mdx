...
| Radoslav Dimitrov  | Stacklok     | [@rdimitrov](https://github.com/rdimitrov)       |         | Lead      |
| Bob Dickinson      | TeamSpark    | [@BobDickinson](https://github.com/BobDickinson) |         | WG Member |
| Preeti Dewani      | Last9        | [@pree-dew](https://github.com/pree-dew)         |         | WG Member |

## Emeritus Membership

| Name         | Organization | GitHub                                     | Discord | Level     |
| ------------ | ------------ | ------------------------------------------ | ------- | --------- |
| Adam Jones   | Anthropic    | [@domdomegg](https://github.com/domdomegg) |         | WG Member |
| Toby Padilla | GitHub       | [@toby](https://github.com/toby)           |         | WG Member |
