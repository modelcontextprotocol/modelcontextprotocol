...
graph TB
    ...
    ServerA["MCP Server A<br/>(e.g., Sentry)"]
    ServerB["MCP Server B<br/>(e.g., Filesystem)"]
    ServerC["MCP Server C<br/>(e.g., Database)"]

    Client1 ---|"Dedicated<br/>connection"| ServerA
    Client2 ---|"Dedicated<br/>connection"| ServerA
    Client3 ---|"Dedicated<br/>connection"| ServerB
