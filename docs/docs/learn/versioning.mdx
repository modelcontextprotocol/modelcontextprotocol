...
Deprecated features have a documented migration path and stay in the
specification for at least twelve months before they become eligible for
removal, after which they may be **Removed** in a future revision.
