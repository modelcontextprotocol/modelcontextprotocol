...
Make sure to replace `your_key_here` with your actual API key, **removing any angle brackets**. Your `.env` file should look like:

```plaintext
ANTHROPIC_API_KEY=sk-ant-api03-example1234567890abcdefghijklmno
```
