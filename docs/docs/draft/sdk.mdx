...
| <Icon icon="gem" size={24} /> &nbsp; [Ruby](https://ruby.sdk.modelcontextprotocol.io)           | [modelcontextprotocol/ruby-sdk](https://github.com/modelcontextprotocol/ruby-sdk)             |   <Badge color="blue" shape="pill">Tier&nbsp;1</Badge> |
