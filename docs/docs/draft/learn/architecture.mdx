...
- **Client features**: Enables servers to elicit input from the user. Sampling from the host LLM and logging messages to the client are deprecated as of protocol version `2026-07-28`.
