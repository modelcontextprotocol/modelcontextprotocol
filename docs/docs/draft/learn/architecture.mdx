...
- **Client features**: Enables servers to elicit input from the user. Sampling and logging are [deprecated](/specification/draft/deprecated) as of protocol version `2026-07-28`.
