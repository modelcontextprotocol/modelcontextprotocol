...
See [Recipes → Hosting on a network](/docs/draft/tools/inspector/recipes#hosting-on-a-network) for the full matrix, and [Configuration](/docs/draft/tools/inspector/configuration#web-backend-environment-variables) for the variables.
