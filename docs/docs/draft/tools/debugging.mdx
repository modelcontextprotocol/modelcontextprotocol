...
Logging is deprecated as of protocol version `2026-07-28`. It remains
available during the deprecation window, but new servers should log to stderr
(stdio transport) or use [OpenTelemetry](https://opentelemetry.io/) instead.
