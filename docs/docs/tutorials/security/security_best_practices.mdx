...
server supports
[Client ID Metadata Documents](/specification/latest/basic/authorization#client-id-metadata-documents),
...
See
[Localhost Redirect URI Risks](/specification/latest/basic/authorization#localhost-redirect-uri-risks)
...
[Trust Policies](/specification/latest/basic/authorization#trust-policies)
...
<Note>
  ...
  **SHOULD** compute the union of previously requested scopes and newly
  ...
  Authorization
  Flow](/specification/latest/basic/authorization#step-up-authorization-flow).
