...
- **Request identifier hardening**. Never tie authorization decisions to request or subscription identifiers. Authorization **MUST** be based solely on the bearer token presented on each request.
