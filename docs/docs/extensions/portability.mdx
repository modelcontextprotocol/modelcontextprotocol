...
<Note>
Always implement the `postMessage` path first. Treat host-specific APIs as optional enhancements, not requirements.
</Note>
...
<head>
  <style>
    .widget { padding: 16px; font-family: system-ui; }
  </style>
</head>
<body>
