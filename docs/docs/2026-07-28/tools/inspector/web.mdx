...
Modern-era servers add two things here — mirrored `Mcp-Param-*` headers and excluded tools, plus the distinct `-32602` error panels. Both are covered in [Protocol eras](/docs/2026-07-28/tools/inspector/protocol-eras#tools-mirrored-headers-and-excluded-tools).
...
See [Recipes → Hosting on a network](/docs/2026-07-28/tools/inspector/recipes#hosting-on-a-network) for the full matrix, and [Configuration](/docs/2026-07-28/tools/inspector/configuration#web-backend-environment-variables) for the variables.
