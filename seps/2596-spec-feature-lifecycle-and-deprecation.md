...
in [SEP-1730][sep-1730]. Item 4 of [Removing a feature](#removing-a-feature) is the separate
confirmation that Tier 1 SDKs have shipped the migration path before removal proceeds.
