...
the agent 1. that the tool call is waiting for approvals and optionally 2. what kind of approvals the tool call is waiting for. The SEP also enables
...
interface MpasTaskMeta {
  ...
  authorizationState:
    "submitted" | "authorization_required" | "pending" | "approvals_collected";
...
In MPAS, both proposers and maintainers are _signers_ — they hold private
