...
This uses the standard JSON-RPC "invalid params" error code, as the URI parameter references a non-existent resource.
...
3. Servers should use error code `-32602` for resource not found
